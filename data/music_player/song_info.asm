SongInfo:
	...
	db "Lugia's Song@", ORIGIN_M02, COMPOSER_JOHN_LISSAUER_RALPH_SCHUCKETT, COMPOSER_PUM
	...
	db "Seven Nation Army@", ORIGIN_LDS, COMPOSER_WHITESTRIPES, COMPOSER_CARSONBUSH
	db "Bring His Truth@", ORIGIN_LDS, COMPOSER_CARSONBUSH, COMPOSER_CARSONBUSH
	db "Battle! Missionary@", ORIGIN_LDS, COMPOSER_CARSONBUSH, COMPOSER_CARSONBUSH
	db "Untraveled Road@", ORIGIN_LDS, COMPOSER_THOUS_FT_KRUTCH, COMPOSER_CARSONBUSH
	db "Ghostbusters@", ORIGIN_LDS, COMPOSER_RAY_PARKER, COMPOSER_CARSONBUSH
	db "If You Could Hie    to Kolob@", ORIGIN_LDS, COMPOSER_NEPH, COMPOSER_CARSONBUSH
	db "Sweet Child o'      Mine@", ORIGIN_LDS, COMPOSER_GUNS_N_ROSES, COMPOSER_CARSONBUSH
	db "Magic@", ORIGIN_LDS, COMPOSER_PILOT, COMPOSER_CARSONBUSH
	db "The Battle of       Final Destiny@", ORIGIN_EB, COMPOSER_SUZUKI_TANAKA, COMPOSER_CARSONBUSH
	db -1
