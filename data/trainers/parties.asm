...
; ================
	...
	db 70, TOGEKISS, LEFTOVERS
		db ANCIENTPOWER, HURRICANE, NASTY_PLOT, SOFTBOILED
...
; ================
	...
	db 72, CLEFABLE, PINK_BOW, ABILITY_1 | QUIRKY, FEMALE
		db CALM_MIND, MOONBLAST, SOFTBOILED, THUNDER_WAVE
	...
	db 75, MILTANK, BRIGHTPOWDER, ABILITY_2 | QUIRKY, FEMALE ; Scrappy
		db DEFENSE_CURL, ROLLOUT, MILK_DRINK, BODY_SLAM
	db -1 ; end
...
; ================
	...
	db 73, JOLTEON, NEVERMELTICE, DVS_HP_ICE
		db HIDDEN_POWER, THUNDER_WAVE, HYPER_VOICE, THUNDERBOLT ; HP Ice
	db 72, MAGNEZONE, CHARCOAL, DVS_HP_FIRE
		db LIGHT_SCREEN, DOUBLE_TEAM, HIDDEN_POWER, THUNDERBOLT ; HP Fire
...
; ================
	...
	; party
	db 33, GRAVELER
		db SELFDESTRUCT, ROCK_THROW, DEFENSE_CURL, MAGNITUDE
	db 33, GRAVELER
		db SELFDESTRUCT, ROCK_THROW, DEFENSE_CURL, MAGNITUDE
	db 36, MAGCARGO
...
; ================
	...
	; party
	db 47, CHANSEY
		db ROLLOUT, ATTRACT, RETURN, SOFTBOILED
	db -1 ; end
...
; ================
	...
	; party
	db 36, SNORLAX
		db HEADBUTT, DEFENSE_CURL, ROLLOUT, SELFDESTRUCT
	db 36, PORYGON2
...
; ================
	...
	db 16, CHANSEY, KINGS_ROCK, $EE, $EE, $EE, ABILITY_2 | QUIRKY, MALE
		db HEADBUTT, SOFTBOILED, SWEET_KISS, ZEN_HEADBUTT
...
; ================
	...
	; party
	db 36, CHARMELEON
		db SMOKESCREEN, METAL_CLAW, DRAGON_RAGE, FLAME_WHEEL
	db 35, MAGNETON
...
; ================
	...
	db 45, ARCANINE, NO_ITEM
		db BITE, LEER, TAKE_DOWN, FLAME_WHEEL
...
; ================
	...
	db 39, ARCANINE, CHARCOAL
		db FLAME_WHEEL, FLAMETHROWER, DOUBLE_KICK, TAKE_DOWN
...
; ================
	...
	db 39, TOGEKISS, LEFTOVERS
		db FLY, SOFTBOILED, AURA_SPHERE, EXTREMESPEED
...
; ================
	...
	db 42, WEEZING, CHARCOAL
		db FIRE_BLAST, SELFDESTRUCT, SLUDGE_BOMB, SMOKESCREEN
	db -1 ; end
...
; ================
	...
	db 39, KOFFING, EVIOLITE
		db TACKLE, SELFDESTRUCT, VENOSHOCK, SMOKESCREEN
...
; ================
	...
	db 36, WEEZING, POISON_BARB, 108
		db ENDURE, WILL_O_WISP, SLUDGE_BOMB, SELFDESTRUCT
	db -1 ; end
...
; ================
	...
	db 28, WEEZING, SILK_SCARF, 88
		db WILL_O_WISP, SELFDESTRUCT, VENOSHOCK, SMOKESCREEN
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 40, ARBOK, POISON_BARB, ABILITY_1 | QUIRKY, FEMALE | ARBOK_ARIANA_FORM
		db GLARE, SCREECH, ACID, CRUNCH
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 35, ARBOK, BLACKGLASSES, ABILITY_1 | QUIRKY, FEMALE | ARBOK_ARIANA_FORM
...
; ================
	...
	db 29, ALAKAZAM, TWISTEDSPOON, DVS_HP_FIGHTING, ABILITY_1 | QUIRKY, MALE
		db REFLECT, LIGHT_SCREEN, HIDDEN_POWER, PSYBEAM ; HP Fighting
	db -1 ; end
...
; ================
	...
	db 40, CLOYSTER, NO_ITEM, 120
		db DEFENSE_CURL, ROLLOUT, AURORA_BEAM, SELFDESTRUCT
...
; ================
	...
	db 60, TOGEKISS, WISE_GLASSES
		db AIR_SLASH, AURA_SPHERE, SOFTBOILED, NASTY_PLOT
...
; ================
	...
	db 73, CLEFABLE, LEFTOVERS
		db MOONBLAST, CALM_MIND, SOFTBOILED, THUNDER_WAVE
